...
Ce projet a été réalisé en BUT1 lors d'une SAE (Situation d'apprentissage évaluée) en groupe de 2 dans laquelle nous devions répondre à une demande d'une entreprise. Cette dernière avait besoin d'un ensemble de postes à mettre sur pied avec un environnement de développement adéquat. Tout cela avec un budget de 1000€ maximum par poste.
...
**Notions et connaissances abordées:**
- Hardware et Software
- Bases de Linux
- fichiers de configuration Linux
- Installations et configurations d'OS classiques
